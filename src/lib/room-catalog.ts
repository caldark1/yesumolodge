...
export const ROOM_CATALOG: Record<RoomCategoryKey, RoomCatalogEntry> = {
  queen: {
    ...
    amenities: ["Queen Bed", "Air Conditioning", "TV", "Fridge", "Free WiFi", "Hot Water", "Workspace"],
    images: [
  ...
  deluxe: {
    ...
    amenities: ["Double Bed", "Air Conditioning", "TV", "Fridge", "Free WiFi", "Hot Water", "Room Service"],
    images: [
  ...
  standard: {
    ...
    amenities: ["Double Bed", "Air Conditioning", "TV", "Fridge", "Free WiFi", "Hot Water"],
    images: [
